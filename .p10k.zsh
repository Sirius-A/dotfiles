# Generated by Powerlevel10k configuration wizard on 2022-10-18 at 15:27 CEST.
...
() {
  ...
  # Available sources:
  #
  # - shell   version is set via a shell variable (e.g. MISE_${TOOL}_VERSION)
  # - local   version comes from a config file in the current directory or a parent
  # - global  version comes from the global mise config (~/.config/mise/config.toml)
  #
  ...
  # typeset -g POWERLEVEL9K_MISE_GOLANG_SHOW_ON_UPGLOB='*.foo|*.bar'
  ...
  # typeset -g POWERLEVEL9K_MISE_DOTNET_CORE_SHOW_ON_UPGLOB='*.foo|*.bar'
